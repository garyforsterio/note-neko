 ...
 */
function generateJSON(prompt, schema, systemPrompt) {
    return __awaiter(this, void 0, void 0, function () {
        var client, completion, content, parsed, error_1;
        var _a, _b;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, client.chat.completions.create({
                            ...
                            response_format: (0, zod_1.zodResponseFormat)(schema, "result"),
                            temperature: 0.1,
                        })];
                case 2:
                    completion = _c.sent();
                    content = (_b = (_a = completion === null || completion === void 0 ? void 0 : completion.choices[0]) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.content;
                    if (!content) {
                ...
                case 3:
                    error_1 = _c.sent();
                    console.error("LLM JSON generation error:", error_1);
                    throw error_1;
