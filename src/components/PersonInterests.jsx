...
exports.PersonInterests = PersonInterests;
var server_1 = require("#lib/i18n/server");
function PersonInterests(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var t;
        var currentInterests = _b.currentInterests;
        return __generator(this, (_c) => {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, server_1.getTranslations)()];
                case 1:
                    t = _c.sent();
                    return [2 /*return*/, (<div className="mb-4">
			<h2 className="text-lg font-semibold mb-2">{t("people.interests")}</h2>
			<div className="flex flex-wrap gap-2">
				{/* Current interests */}
				{currentInterests.map((interest) => (<span key={interest} className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm">
						{interest}
					</span>))}
			</div>
		</div>)];
