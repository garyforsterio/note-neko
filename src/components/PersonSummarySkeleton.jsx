...
exports.PersonSummarySkeleton = PersonSummarySkeleton;
var skeleton_1 = require("#components/ui/skeleton");
var server_1 = require("#lib/i18n/server");
function PersonSummarySkeleton() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, (_a) => {
            switch (_a.label) {
                ...
                case 1:
                    t = _a.sent();
                    return [2 /*return*/, (<div className="bg-white rounded-lg shadow-md p-6 mb-8">
			...
			<div className="mb-6">
				...
				<skeleton_1.Skeleton className="h-4 w-full mb-2"/>
				<skeleton_1.Skeleton className="h-4 w-3/4 mb-4"/>
				<skeleton_1.Skeleton className="h-4 w-full mb-2"/>
			...
			<div className="mb-6">
				<skeleton_1.Skeleton className="h-6 w-32 mb-3"/>
				<div className="space-y-2">
					{__spreadArray([], Array(4), true).map((_) => (<div key={crypto.randomUUID()} className="flex items-start gap-2">
			...
			<div className="border-t border-gray-200 pt-4">
				<skeleton_1.Skeleton className="h-6 w-48 mb-3"/>
				<skeleton_1.Skeleton className="h-4 w-full mb-2"/>
			...
			<div className="mt-6 pt-4 border-t border-gray-100">
				<skeleton_1.Skeleton className="h-3 w-64"/>
			</div>
		</div>)];
            }
        });
