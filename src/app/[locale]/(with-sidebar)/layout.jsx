...
var ProcessingContext_1 = require("#contexts/ProcessingContext");
function Layout(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var children = _b.children;
        return __generator(this, (_c) => [2 /*return*/, (<ProcessingContext_1.ProcessingProvider>
			<Navigation_1.default />
			<main className="min-h-screen bg-gray-50 md:pl-72 pb-16 md:pb-0">
				{children}
			</main>
		</ProcessingContext_1.ProcessingProvider>)]);
    });
}
