...
exports.default = NewDiaryEntryLoading;
var skeleton_1 = require("#components/ui/skeleton");
function NewDiaryEntryLoading() {
    return (<div className="container mx-auto px-4 py-8">
			...
			<div className="space-y-6 max-w-4xl mx-auto">
				...
				<div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 border-b pb-6 border-gray-100">
					<div>
						{/* Day of week */}
						<skeleton_1.Skeleton className="h-10 w-48 mb-3"/>

						{/* Date & Calendar Button */}
						<div className="flex items-center gap-3">
							<skeleton_1.Skeleton className="h-7 w-40"/>
				...
				<div className="flex justify-end space-x-4 pt-4">
					<skeleton_1.Skeleton className="h-10 w-24 rounded-md"/>
					<skeleton_1.Skeleton className="h-10 w-32 rounded-full"/>
				</div>
			</div>
		</div>);
}
