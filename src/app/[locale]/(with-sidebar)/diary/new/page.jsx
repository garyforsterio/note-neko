...
exports.default = NewDiaryEntryPage;
var dal_1 = require("#lib/dal");
var server_1 = require("#lib/i18n/server");
var DiaryForm_1 = require("../components/DiaryForm");
...
function NewDiaryEntryPage(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var _t, date, user, initialDefaultLocation;
        ...
        return __generator(this, (_c) => {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if ((user === null || user === void 0 ? void 0 : user.defaultLocationPlaceId) &&
                        ...
                        (user === null || user === void 0 ? void 0 : user.defaultLocationLat) !== null &&
			...
			<DiaryForm_1.default initialDefaultLocation={initialDefaultLocation} initialDate={date}/>
		</div>)];
            }
        });
    });
