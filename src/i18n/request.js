...
exports.default = (0, server_1.getRequestConfig)((_a) => __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, (_d) => {
        switch (_d.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Promise.resolve("".concat("../../messages/".concat(locale, ".json"))).then((s) => require(s))];
